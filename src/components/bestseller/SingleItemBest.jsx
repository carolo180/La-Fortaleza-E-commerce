...
const SingleItemBest = ({  currentItem, addToCart }) => {
            ...
            <div className="modal-body" id="bodym">
              ...
              <div id="descri">
                ...
                <div class="modal-footer">
                    <button className="addtocar" onClick={() =>{addToCart( currentItem.id);  addCartNotification()} }>Add To Cart <FaCartPlus/></button>
...
export default connect(mapStateToProps, mapDispatchToProps)(SingleItemBest);